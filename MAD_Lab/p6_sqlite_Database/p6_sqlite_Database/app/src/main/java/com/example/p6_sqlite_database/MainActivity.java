...
//                    "','"+Marks.getText()+"');");   //never pass parameters by string concatination, as it may lead to sql injection attack eg. paste 1', 'Hacker', '100'); -- in rollno field to insert data

            db.execSQL("INSERT INTO student VALUES(?, ?, ?);",
                    new Object[]{Rollno.getText().toString(), Name.getText().toString(), Marks.getText().toString()});  //use parameterized query instead using ? placeholder
